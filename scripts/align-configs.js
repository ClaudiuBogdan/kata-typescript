...
module.exports.package_json = function (config, day_path) {
  ...
  package_json.scripts.test = `jest ${config.templates.join(" ")}`;
...
module.exports.ts_config = function (set_to) {
  ...
  ts_config.compilerOptions.paths["@code/*"] = [`katas/${set_to}/*`];
...
module.exports.jest = function (set_to) {
  ...
  jest.moduleNameMapper["@code/(.*)"] = [`<rootDir>/src/katas/${set_to}/$1`];
